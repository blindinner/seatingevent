    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-5">
          ...
          <div className="text-2xl font-bold text-white">{formatCurrency(totals.totalRevenue, 'ILS')}</div>
        </div>
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-5">
          <div className="text-sm text-white/50 mb-1">Platform Fees</div>
          <div className="text-2xl font-bold text-green-400">{formatCurrency(totals.platformFees, 'ILS')}</div>
        </div>
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-5">
          <div className="text-sm text-white/50 mb-1">Organizer Payouts</div>
          <div className="text-2xl font-bold text-white/70">{formatCurrency(totals.organizerPayouts, 'ILS')}</div>
        </div>
      </div>
